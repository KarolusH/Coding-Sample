...
# ANES_202029_2D$V201231x <- as.factor(ANES_202029_2D$V201231x)
# ANES_202029_2D$V201231x <- relevel(ANES_202029_2D$V201231x, ref = "0")
# ANES_202029_2$V201549x <- as.factor(ANES_202029_2$V201549x)
# ANES_202029_2$V201549x <- relevel(ANES_202029_2$V201549x, ref = "1")
...
# ANES_202543 <- ANES_202543 %>% 
#   filter(V202541a == 1) %>% # uses facebook
#   filter(V202543 > 0) %>% # facebook comment 
#   filter(!V201233 %in% c(-9, -8)) %>% # trust
#   filter(!V201511x %in% c(-9, -8, -2)) %>% # education
#   filter(!V201231x %in% c(-9, -8)) %>% # party ident 
#   filter(V201600 != -9) %>% # sex
#   filter(V201005 != -9) %>% # freq attention in politics
#   filter(V201507x != -9) %>% # age
#   filter(V201617x > 0) # income
...
# ANES_202545 <- ANES_prepost %>% 
#   filter(V202541b == 1) %>% # uses twitter
#   filter(V202545 > 0) %>% # twitter comment 
#   filter(!V201233 %in% c(-9, -8)) %>% # trust
#   filter(!V201511x %in% c(-9, -8, -2)) %>% # education
#   filter(!V201231x %in% c(-9, -8)) %>% # party ident 
#   filter(V201600 != -9) %>% # sex
#   filter(!V201005 == -9) %>% # interest
#   filter(V201507x != -9) %>% # age
#   filter(V201617x > 0) # income
...
# ANES_202547 <- ANES_prepost %>% 
#   filter(V202541d == 1) %>% # uses reddit
#   filter(V202547 > 0) %>% # reddit comment 
#   filter(!V201233 %in% c(-9, -8)) %>% # trust
#   filter(!V201511x %in% c(-9, -8, -2)) %>% # education
#   filter(!V201231x %in% c(-9, -8)) %>% # party ident 
#   filter(V201600 != -9) %>% # sex
